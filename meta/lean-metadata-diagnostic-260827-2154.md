...
Date and time: 2026-08-27 21:54 PDT
...
- `lem:measurable-linearization` is now `Statement completed` as
  `measurableFourierSupremumLinearization`.
- `thm:dual-difference-interchange` is now `Statement completed` as
