...
Date: 2026-08-28 15:50 PDT

## Inputs

- Blueprint: blueprint/blueprint.tex
- Status source: meta/Status.md
- Updated label: cor:l32-endpoint

## Validation performed

- Confirmed that `cor:l32-endpoint` occurs exactly once as the corollary
...
- Built
  ...
  successfully.
- Audited `Auto.nondecayingLThreeHalvesEndpoint` with `#print axioms`; it
