...
Date: 2026-08-28 14:13 PDT

## Inputs

- Blueprint: blueprint/blueprint.tex
- Status source: meta/Status.md
- Updated label: lem:localized-sobolev-decay

## Validation performed

- Confirmed that `lem:localized-sobolev-decay` occurs exactly once as the
...
- Audited `Auto.localizedNegativeSobolevDecay` with `#print axioms`; it
