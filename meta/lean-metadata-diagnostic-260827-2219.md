...
Date and time: 2026-08-27 22:19 PDT
...
- `lem:l2-endpoint`, `lem:weighted-dyadic-square`, and
  `lem:geometric-summation` are now `Statement completed` as
  `elementaryL2Endpoint`, `weightedDyadicSquareEstimate`, and
  `geometricSummationConstant`.
- `lem:interaction-size-comparison` is now `Statement completed` as
  `interactionSizeComparison`.
