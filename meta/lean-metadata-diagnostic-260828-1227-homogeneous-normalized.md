...
Date: 2026-08-28 12:27 PDT

## Inputs

- Blueprint: blueprint/blueprint.tex
- Status source: meta/Status.md
- Updated label: cor:homogeneous-normalized

## Validation performed

- Confirmed that `cor:homogeneous-normalized` occurs exactly once as the
  corollary label in the canonical blueprint.
...
- Audited `Auto.homogeneousNormalizedSmoothing` with `#print axioms`; it
