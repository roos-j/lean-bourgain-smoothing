...
Date: 2026-08-28 14:19 PDT

## Inputs

- Blueprint: blueprint/blueprint.tex
- Status source: meta/Status.md
- Updated label: prop:dyadic-linfty-decay

## Validation performed

- Confirmed that `prop:dyadic-linfty-decay` occurs exactly once as the
...
- Audited `Auto.dyadicLInfinityDecay` with `#print axioms`; it depends only
