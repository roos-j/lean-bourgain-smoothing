...
Date: 2026-08-28 16:36 PDT

## Inputs

- Blueprint: `blueprint/blueprint.tex`
- Status source: `meta/Status.md`
- Updated label: `prop:special-interpolation`

## Validation performed

- Confirmed that `prop:special-interpolation` occurs exactly once as the
...
- Built
  ...
  successfully.
- Audited `Auto.specialBilinearInterpolation` with `#print axioms`; it
