...
Date and time: 2026-08-27 22:00 PDT
...
- `thm:sobolev-difference` is now `Statement completed` as
  `sobolevDifferenceEstimate`.
- `cor:sobolev-difference-s1` is now `Statement completed` as
  `sobolevDifferenceEstimateS1`.
